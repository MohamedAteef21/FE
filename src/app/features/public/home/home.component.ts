...
@Component({
  ...
  template: `
    <div class="container-fluid px-0">
      <section
        class="hero-section text-center text-white pb-5 mb-5 position-relative overflow-hidden"
      >
        <video
          #heroVideo
          class="hero-video"
        ...
        <button
          class="unmute-button"
          (click)="toggleMute()"
          [attr.aria-label]="isMuted ? ('COMMON.UNMUTE_VIDEO' | translate) : ('COMMON.MUTE_VIDEO' | translate)"
        >
          <svg
            *ngIf="isMuted"
            width="24"
          ...
          >
            <path
              d="M16.5 12C16.5 10.23 15.48 8.71 14.07 7.93L15.5 6.5C17.48 7.61 18.9 9.64 18.9 12C18.9 14.36 17.48 16.39 15.5 17.5L14.07 16.07C15.48 15.29 16.5 13.77 16.5 12ZM19 12C19 8.13 16.36 4.86 12.5 4.03V2.05C17.54 2.88 21.5 7.03 21.5 12C21.5 16.97 17.54 21.12 12.5 21.95V19.97C16.36 19.14 19 15.87 19 12ZM4.27 3L3 4.27L7.73 9H3V15H7L12 20V13.27L16.25 17.53C15.58 18.04 14.83 18.46 14 18.7V20.73C15.38 20.46 16.63 19.93 17.68 19.18L19.73 21.23L21 19.96L4.27 3ZM12 4L9.91 6.09L12 8.18V4Z"
              fill="white"
            />
          </svg>
          <svg
          ...
          >
            <path
              d="M3 9V15H7L12 20V4L7 9H3ZM16.5 12C16.5 10.23 15.48 8.71 14.07 7.93L15.5 6.5C17.48 7.61 18.9 9.64 18.9 12C18.9 14.36 17.48 16.39 15.5 17.5L14.07 16.07C15.48 15.29 16.5 13.77 16.5 12ZM19 12C19 8.13 16.36 4.86 12.5 4.03V2.05C17.54 2.88 21.5 7.03 21.5 12C21.5 16.97 17.54 21.12 12.5 21.95V19.97C16.36 19.14 19 15.87 19 12Z"
              fill="white"
            />
          </svg>
        </button>
        <div class="hero-overlay">
          <div class="hero-logo">
            <img
              ...
              alt="Al Bashawat Restaurant Logo"
            />
          </div>
          <div class="hero-text">
...
<a (click)="navigateToMenu()"class="view-all-link" style="cursor: pointer;font-weight: 700;height: fit-content;display: flex;align-items: center;">{{ "HOME.VIEW_ALL" | translate }}</a>
          ...
          <div class="categories row">
            <div class="category-item col-6 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3"*ngFor="let category of displayCategories"(click)="navigateToCategory(category.nameAr)"style="cursor: pointer;">
              <div class="category-image-wrapper"><img [src]="category.imageUrl"[alt]="currentLang === 'ar' ? category.nameAr : category.nameEn"class="category-image"/>
...
<div class="col-4 col-md-4 col-sm4 col-lg-4 col-xl-4 col-xxl-4">
    ...
    <div class="col-4 col-md-4 col-sm4 col-lg-4 col-xl-4 col-xxl-4"></div>
          ...
          <div class="we-chose-cards" #weChoseCarousel>
            <div class="we-chose-card" *ngFor="let product of weChoseProducts" (click)="navigateToItemDetails(product.id.toString())">
              ...
              <div class="we-chose-content">
                <h3 class="we-chose-title">
                  {{ currentLang === "ar" ? product.nameAr : product.nameEn }}
                </h3>
                <p class="we-chose-description">
                  {{
                    currentLang === "ar"
                ...
                <div class="we-chose-action-row">
                  <div class="we-chose-price">{{ product.basePrice }} {{ "COMMON.RIYAL" | translate }}</div>
                  <button
                    class="we-chose-order-button"
                    (click)="navigateToOffer(product.id.toString()); $event.stopPropagation()"
                  >
            ...
            <div class="carousel-nav" style="display: flex;align-items: center;padding-top: 2rem;justify-content: center;">
              <button
                class="carousel-btn prev-btn"
                (click)="scrollCarousel('we-chose', -1)"
              >
                <span>←</span>
              </button>
              <button
...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild("weChoseCarousel", { static: false })
  weChoseCarousel!: ElementRef<HTMLDivElement>;
  ...
  ngOnInit(): void {
    ...
    this.featuredItems$ = of(
      addLanguageProperty(items, this.translationService),
    );
      ...
      next: (categories) => {
        if (categories.length > 0) {
          ...
          const allProducts = categories
            ...
            .flatMap((cat) =>
              (cat.products || []).filter((p: any) => p.isActive !== false),
            );
  ...
  navigateToItemDetails(productId: string): void {
    this.router.navigate(["/item", productId]).then(() => {
  ...
  navigateToCategory(categoryName: string): void {
    this.router
      .navigate(["/menu"], { queryParams: { category: categoryName } })
      .then(() => {
        this.viewportScroller.scrollToPosition([0, 0]);
      });
  }
  ...
  navigateToMenu(): void {
    ...
    this.router
      .navigate(["/menu"], { queryParams: { category: "الفطار" } })
      .then(() => {
        this.viewportScroller.scrollToPosition([0, 0]);
      });
  }
