...
export class CheckoutComponent implements OnInit, OnDestroy {
  ...
  submitOrder(): void {
    ...
    // ── Guest users without createAccount → show the local success modal ─────
    this.buildOrderSuccessData(formValue, cart, undefined);
    this.showOrderSuccess = true;
  }
  ...
  getValidationMessages(): string[] {
    ...
    // Check create account for non-authenticated users
    if (!this.isAuthenticated && !this.createAccount) {
